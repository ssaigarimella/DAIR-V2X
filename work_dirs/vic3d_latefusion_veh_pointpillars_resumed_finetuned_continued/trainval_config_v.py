...
z_center_car = -1.78
work_dir = '/workspace/DAIR-V2X/work_dirs/vic3d_latefusion_veh_pointpillars_resumed_finetuned_continued'
model = dict(
    type='VoxelNet',
    voxel_layer=dict(
        max_num_points=32,
    ...
    voxel_encoder=dict(
        ...
        point_cloud_range=[0, -39.68, -3, 92.16, 39.68, 1]),
    middle_encoder=dict(
        type='PointPillarsScatter', in_channels=64, output_shape=[496, 576]),
    backbone=dict(
        type='SECOND',
        in_channels=64,
        layer_nums=[3, 5, 5],
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            ranges=[[0, -39.68, -0.6, 92.16, 39.68, -0.6],
...
train_pipeline = [
    ...
    dict(
        ...
        db_sampler=dict(
            data_root=
            '../../../../data/DAIR-V2X/cooperative-vehicle-infrastructure/vehicle-side/',
            info_path=
            '../../../../data/DAIR-V2X/cooperative-vehicle-infrastructure/vehicle-side//kitti_dbinfos_train.pkl',
            rate=1.0,
            prepare=dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            pipeline=[
                ...
                dict(
                    ...
                    db_sampler=dict(
                        ...
                        '/workspace/DAIR-V2X/data/DAIR-V2X/cooperative-vehicle-infrastructure/vehicle-side/',
                        info_path=
                        '/workspace/DAIR-V2X/data/DAIR-V2X/cooperative-vehicle-infrastructure/vehicle-side/kitti_dbinfos_train.pkl',
                        rate=1.0,
                        prepare=dict(
                            filter_by_difficulty=[-1],
            ...
            classes=['Pedestrian', 'Cyclist', 'Car'],
            test_mode=False,
            pcd_limit_range=[0, -39.68, -3, 92.16, 39.68, 1],
            box_type_3d='LiDAR')),
    val=dict(
        type='KittiDataset',
        data_root=
...
log_level = 'INFO'
load_from = None
resume_from = '/workspace/DAIR-V2X/configs/vic3d/late-fusion-pointcloud/pointpillars/vic3d_latefusion_veh_pointpillars_a70fa05506bf3075583454f58b28177f.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 1)
total_epochs = 30
