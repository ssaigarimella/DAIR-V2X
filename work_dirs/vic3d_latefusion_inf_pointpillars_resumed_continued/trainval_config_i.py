...
z_center_car = -1.78
work_dir = '/workspace/DAIR-V2X/work_dirs/vic3d_latefusion_inf_pointpillars_resumed_continued'
model = dict(
    type='VoxelNet',
    voxel_layer=dict(
        max_num_points=32,
            ...
            pipeline=[
                ...
                dict(
                    ...
                    db_sampler=dict(
                        ...
                        '/workspace/DAIR-V2X/data/DAIR-V2X/cooperative-vehicle-infrastructure/infrastructure-side/',
                        info_path=
                        '/workspace/DAIR-V2X/data/DAIR-V2X/cooperative-vehicle-infrastructure/infrastructure-side/kitti_dbinfos_train.pkl',
                        rate=1.0,
                        prepare=dict(
                            filter_by_difficulty=[-1],
...
log_level = 'INFO'
load_from = None
resume_from = '/workspace/DAIR-V2X/configs/vic3d/late-fusion-pointcloud/pointpillars/vic3d_latefusion_inf_pointpillars_596784ad6127866fcfb286301757c949.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 1)
total_epochs = 30
